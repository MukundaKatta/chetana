...
describe("ALL_PROBES", () => {
  it("contains probes from all exported sets", () => {
    const allSets = [
      ...
      counterfactualReasoningProbes, humorProbes, moralReasoningProbes,
      recurrenceProbes, temporalDepthProbes,
      predictionErrorProbes, counterfactualProbes, surpriseProbes,
      attentionSchemaProbes, voluntaryAttentionProbes,
      unifiedAgencyProbes, curiosityProbes, volitionProbes,
      selfReportProbes, consistencyProbes, resistanceProbes, imaginationProbes,
